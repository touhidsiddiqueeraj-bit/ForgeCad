...
(function (global) {
  ...
  var mode3D = {
    ...
    populateShapePanel: function () {
      ...
      html += this._shapeBtn('pyramid', '⛰', 'Pyramid');
      html += this._shapeBtn('prism', '📐', 'Prism');
      html += this._shapeBtn('hemisphere', '🌓', 'Half-Sphere');
      html += this._shapeBtn('capsule', '💊', 'Capsule');
      html += '</div>';
      html += '<div class="shape-section-label">Specialty</div>';
      html += '<div class="shape-grid">';
      html += this._shapeBtn('wedge', '🔻', 'Wedge');
      html += this._shapeBtn('roof', '🏠', 'Roof');
      html += this._shapeBtn('text', '🔤', 'Text');
      ...
      html += this._shapeBtn('tetra', '🔶', 'Tetra');
      html += this._shapeBtn('octa', '💠', 'Octa');
      html += this._shapeBtn('arrow', '➡', 'Arrow');
      html += this._shapeBtn('spring', '🌀', 'Spring');
      html += '</div>';
